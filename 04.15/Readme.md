...
3. Aşağıdakı DML SQL sorğularını yazın:
...
4. Aşağıdakı DDL SQL sorğularını yazın:
    - `Doctors` cədvəlinə `Email` sütunu əlavə edin (maksimum 100 simvol).
    - `Patients` cədvəlinə `Address` sütunu əlavə edin (maksimum 200 simvol).